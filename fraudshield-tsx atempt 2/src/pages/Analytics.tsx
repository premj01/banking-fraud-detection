...
import { GeoHeatmapData, ModelPerformance, RulePerformance } from "@/types/fraud";
                  ...
                  <div key={city.city} className="flex items-center justify-between text-sm">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className={cn(
                        ...
                        city.risk_score > 0.6 ? "bg-risk-high/10 text-risk-high" :
                        city.risk_score > 0.3 ? "bg-risk-medium/10 text-risk-medium" :
