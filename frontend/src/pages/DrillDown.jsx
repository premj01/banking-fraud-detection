                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <Badge className={cn(
                                        user.risk_level === 'High' ? 'bg-red-500' :
                                            user.risk_level === 'Medium' ? 'bg-amber-500' :
                                                'bg-emerald-500',
                                        'text-white'
                                    )}>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <p className={cn(
                                        ...
                                        selectedTxn.risk_score > 0.7 ? "text-red-500" :
                                            selectedTxn.risk_score > 0.4 ? "text-amber-500" :
                                                "text-emerald-500"
                                    )}>
                                    ...
                                    <Badge className={cn(
                                        "text-xs capitalize",
                                        selectedTxn.status === 'approved' ? 'bg-emerald-500' :
                                            selectedTxn.status === 'flagged' ? 'bg-amber-500' :
                                                'bg-red-500',
                                        'text-white'
                                    )}>
                                        {selectedTxn.status}
                                ...
                                <div className="mt-6 pt-6 border-t border-border/50">
                                    ...
                                    <div className="space-y-2">
                                        {selectedTxn.rule_hits.map((rule, i) => (
                                            <div key={i} className="flex items-start gap-2 p-2 rounded-lg bg-amber-500/10 text-sm">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="glass-card rounded-lg p-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Button variant="outline" className="w-full justify-start text-red-500 hover:text-red-500" size="sm">
